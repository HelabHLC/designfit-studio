const layers = [
  ["1. Public knowledge layer", "ARBE pages, terminology, specifications, provenance statements and public project status."],
  ...
  return (
    <main className="content-page shell">
      ...
      <div className="prose">
        ...
        <section><h2>Repository roles</h2><p><code>arbe-lambda</code> is the normative scientific reference. <code>designfit-studio</code> is the ARBE application and controlled runtime integration layer.</p></section>
      </div>
    </main>
  );
}
